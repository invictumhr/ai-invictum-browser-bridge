...
const ACTION_RISK_LEVELS: Readonly<Record<string, RiskLevel>> = {
  ...
  [BROWSER_GET_FIGMA_DOCUMENT_ACTION]: "R0",
  [BROWSER_GET_FIGMA_LAYERS_ACTION]: "R0",
  [BROWSER_GET_FIGMA_PROPERTIES_ACTION]: "R0",
  // Driving Figma's own page/mode/layer controls stays R1: it changes the live
  // document selection that collaborators can see, but mutates no content.
  [BROWSER_FIGMA_SELECT_ACTION]: "R1",
  [BROWSER_FIGMA_HEALTHCHECK_ACTION]: "R0",
  ...
  [BROWSER_GET_TERMINALS_ACTION]: "R0",
  [BROWSER_READ_TERMINAL_ACTION]: "R2",
  [BROWSER_TERMINAL_INPUT_ACTION]: "R3",
